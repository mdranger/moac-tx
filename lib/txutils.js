...
/**
Extra functions from eth-js, isHexPrefixed, module
**/
/**
...
function padToEven(value) {
  ...
  if (typeof a !== 'string') {
    throw new Error(`[moac-lib-txutil] while padding to even, value must be string, is currently ${typeof a}, while padToEven.`);
  }
